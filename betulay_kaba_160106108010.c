    ...
    printf("\n \n\t ***ESIKLENMIS DIZI*** \n\n"); // printf kullanarak ekrana ***ESIKLENMIS DIZI*** yazdýrdýk
{
	...
	printf("\t255  ",esiklenmis_dizi[i]); // 120 den büyük çýkýnca o sayý yerine 225 yazdýrdýk
	else 
    ...
    printf(" \n\t ***ESIKLENMIS MATRIS*** \n\n");  //printf kullanarak ekrana *** ESIKLENMIS MATRIS*** yazdýrdýk
{
	...
	printf("\t255  ",esiklenmis_matris[i][j]); //120 den büyük çýkýnca o sayý yerine 225 yazdýrdýk
	else 
